                                    ...
                                    <form className="dzForm"  onSubmit={(e) => formDetails(e)}>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-4 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.4s">
                                                <input name="dzPhoneNumber" required="" type="number" className="form-control" placeholder="Phone Number" />
                                            </div>
								...
								<div className="dz-card style-2" style={{backgroundImage: "url("+ bloglg +")"}}>
									<div className="dz-category">
										<ul className="dz-badge-list">
											<li><Link to={"#"} className="dz-badge">14 Feb 2024</Link></li>
										</ul>
									</div>
									<div className="dz-info">
										...
										<div className="dz-meta">
											<ul>
												...
												<li className="post-date"><Link to={"#"}> 12 May 2024</Link></li>
											</ul>
										</div>
									</div>
								</div>
